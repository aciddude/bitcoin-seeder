...
static const string mainnet_seeds[] = {"seed0.trezarcoin.com", "seed.trezarcoin.network", ""};
static const string testnet_seeds[] = {"testnet-seed.trezarcoin.com",
                                       "testnet-seed.trezarcoin.network",
                                       ""};
